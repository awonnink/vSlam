...
namespace HoloToolkit.Unity.InputModule.Utilities.Interactions
{
    ...
    /// </summary>
    public class MRTwoHandManipulatable : MonoBehaviour, IInputHandler, ISourceStateHandler
    {
        [SerializeField]
        ...
        public TwoHandedManipulation ManipulationMode = TwoHandedManipulation.Scale;
